...
const ServiceCard = ({color, title, icons, subtitle}) => (
  <div className="flex flex-row justify-start items-center white-glassmorphism p-3 m-2 cursor-pointer hover:shadow-xl">
    ...
    <div className="ml-5 flex flex-col flex-1"><h1 className='text-white mt-2 text-lg'>{title}</h1>
  ...
  return (
    <div className="flex flex-col md:flex-row w-full justify-center items-center gradient-bg-services">
      ...
      <div className="flex flex-1 flex-col justify-start items-center">
        ...
        subtitle="Security is guaranteed. We always maintain privacy and maintain the quality of service"
        />
        <ServiceCard 
        color="bg-[#8945F8]" 
