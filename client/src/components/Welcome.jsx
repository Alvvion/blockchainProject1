    ...
    <div className='flex w-full justify-center items-center'>
      <div className='flex mf:flex-row flex-col items-start justify-between md:p-20 py-20 px-4'>
        <div className='flex flex-1 justify-start flex-col mf:mr-10'>
          ...
          className='flex flex-row justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd]'><span className='text-white text-base font-semibold'>Connect Wallet</span></button>)}
